...
BookCreator::BookCreator(std::ifstream& input) {
    ...
    //there is nothing in "line" here anymore. But I think they were adding to the file here so that's okay?
    currLineIdx = 0;
}
...
Book* BookCreator::createBook() {
    ...
    //CHANGED HERE "setPages" to "setHours"
                book->setHours(info.getInfo()); //Here, it changed the pages to the set hours (as an int and not as a double, too). Also, this is why the hours stayed at 0.
            }
